...
![Placeholder](img/myphoto.jpg){: align=left width=314 }
  ...
  <div class="tx-switch">
    <button data-md-color-scheme="default"><a class="md-button" style="margin: 3px 25px">ライト</a></button>
    <button data-md-color-scheme="slate"><a class="md-button md-button--primary" style="margin: 3px 25px">ダーク</a></button>
  </div>
